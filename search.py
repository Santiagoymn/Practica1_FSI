...
def ramificacion_acotacion(problem):
    """ Ordenar la lista abierta tomando como criterio el coste acumulado de cada trayectoria parcial """
    return graph_search(problem, AR())

def ramificacion_acotacion_con_heuristica(problem):
    """ Ordenar la lista abierta tomando como criterio el coste acumulado de cada trayectoria parcial """
    return graph_search(problem, AR_heuristica(problem))
